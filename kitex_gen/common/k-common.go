...
func (p *User) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "Passport", thrift.STRING, 2)
	offset += bthrift.Binary.WriteStringNocopy(buf[offset:], binaryWriter, p.Passport)
...
func (p *User) field2Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("Passport", thrift.STRING, 2)
	l += bthrift.Binary.StringLengthNocopy(p.Passport)
